...
type Sponsor = Tables<"Sponsors"> & { person?: Tables<"People"> };
...
export const BillKeyInformation = ({ bill, sponsors, totalSponsors }: BillKeyInformationProps) => {
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-sm font-medium">
                {bill.bill_number?.startsWith('S') ? 'Senate Bill' : 
                 bill.bill_number?.startsWith('A') ? 'Assembly Bill' : 'Unknown'}
              </p>
            </div>
