...
import { ChartSlider } from "@/components/dashboard/ChartSlider";
      ...
      <div className="container mx-auto px-[27px] py-4 sm:py-6 max-w-7xl">
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 xl:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
            ...
            <Card className="hover:shadow-md transition-shadow cursor-pointer bg-blue-400 text-white" onClick={handleViewAllChats}>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 px-3 sm:px-4 pt-3 sm:pt-4">
                <CardTitle className="text-xs sm:text-sm font-medium truncate text-white">Active Chats</CardTitle>
              </CardHeader>
              <CardContent className="px-3 sm:px-4 pb-3 sm:pb-4">
                <div className="text-2xl sm:text-3xl xl:text-4xl font-bold text-white">{stats.activeChats.toLocaleString()}</div>
              </CardContent>
            </Card>
