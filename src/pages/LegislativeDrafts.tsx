...
const LegislativeDrafts = () => {
  ...
  return <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="mb-8">
          <ProblemSolverSection onProblemGenerated={handleProblemGenerated} onDraftBill={() => {}} />
        </div>

        {/* Output Area */}
        {showOutput && <div className="mb-8">
            ...
            <div className="flex gap-3 mt-4">
              <Button variant="outline" onClick={handleSave} className="bg-white hover:bg-gray-50">
                Save
              </Button>
              <Button onClick={handleSaveAndSubmit} className="bg-gray-900 hover:bg-gray-800 text-white">
                Save & Submit
              </Button>
            </div>
          </div>}
